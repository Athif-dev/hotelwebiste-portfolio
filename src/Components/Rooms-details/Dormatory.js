...
e.preventDefault();
  ...
  return (
    ...
    <p className='information-desc'>Dormatory room are budget-friendly offering comfortable stays for a group of 8-12 people. There are comfortable individual beds, ensuite bathrooms and comfortable living space.</p>
